...
This file provides guidance for Gemini and Antigravity agents working in this repository.
...
### 执行要点摘要
1. **自动闭环衔接**：无 Ready 清单时自动启动 Phase C 有界现场核验，生成 Ready Allowlist，不要求用户手动准备。
